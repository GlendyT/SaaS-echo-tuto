...
const VapiPluginForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      setOpen(false);
      toast.success("Successfully connected Vapi");
    } catch (error) {
      console.error(error);
      toast.error("There was an error connecting Vapi");
    }
  };
  ...
  return (
    <Dialog onOpenChange={setOpen} open={open}>
      <DialogContent>
        ...
        <DialogDescription>
          Your API keys are safely encrypted and sotred using AWS secrets
          Manager
        </DialogDescription>
...
const VapiPluginRemoveForm = ({
  ...
  const onSubmit = async () => {
    try {
      ...
      console.error(error);
      toast.error("There was an error removing Vapi plugin");
    }
  };
  ...
  return (
    <Dialog onOpenChange={setOpen} open={open}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Desconect Vapi</DialogTitle>
        </DialogHeader>
        <DialogDescription>
          Are you sure you want to disconnect Vapi? This action cannot be
          undone.
        </DialogDescription>
        <DialogFooter>
