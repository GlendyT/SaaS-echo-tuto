  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-y-2 bg-muted p-8">
        ...
        <p className="text-muted-foreground text-sm"> Loading Settings...s</p>
      </div>
    );
  }
  return (
    <div className="flex min-h-screen flex-col bg-muted p-5">
      <div className="max-w-screen-md mx-auto w-full">
        <div className="space-y-2">
          <h1 className="text-2xl md:text-4xl">Widget Customization</h1>
          <p className="text-muted-foreground">
            Customizae how your chat widet looks and behaves for your customers
          </p>
        </div>
        <div className="mt-8">
